        ...
        <div class="content-item">
          ...
          <div class="header-right">
            <el-select v-model="modelObj.ftype">
              ...
              <el-option label="车辆故障" value="3" />
              <el-option label="未知故障" value="8" />
            </el-select>
          </div>
        </div>
        <div class="content-item">
          ...
          <div class="header-right">
            <el-select v-model="modelObj.etype">
              <el-option label="全部" value="" />
              <el-option label="发生故障" value="0" />
              <el-option label="自动修复故障" value="1" />
              <el-option label="手动修复故障" value="2" />
            </el-select>
          </div>
        </div>
        <div class="content-item">
        ...
        <div class="table">
          ...
          <div class="table-body" v-loading="listLoading">
            ...
            >
              ...
              <div class="table-td">
                <div class="td-item">
                  {{ fault.ftype ? ftype_array[fault.ftype] : "--" }}
                </div>
              </div>
              <div class="table-td">
                <div class="td-item" v-if="fault.ftype == 8">
                  {{ fault.code ? fault.code : "--" }}
                </div>
                <div class="td-item" v-else>
                  {{ fault.desc ? fault.desc : "--" }}
                </div>
              </div>
              <div class="table-td">
              ...
              <div class="table-td">
                <div class="td-item td-time">
                  {{ fault.etype == 2 && fault.dt ? fault.dt : "--" }}
                </div>
              </div>
            </div>
            <div
