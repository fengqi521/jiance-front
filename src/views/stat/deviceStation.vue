        ...
        <div class="section-header">
            ...
            <div class="header-content clearfix">
                <div class="content-item">
                    ...
                    <el-input class="search-input" v-model="modelObj.words" placeholder="关键字搜索" />
                </div>
                <div class="content-item">
            ...
            <div class="section-main">
                <div class="table">
                    ...
                    <div class="table-body" v-loading="listLoading">
                        <div class="table-tr" v-show="tableData && tableData.length" v-for="(station, index) in tableData" :key="index">
                            ...
                            <div class="table-td">
                                <div :class="['td-item', station.station_status != 0 && station.station_status != 50 ? 'section-no-begin' : 'section-end']">
                            ...
                            <div class="table-td table-operate">
                                <el-tooltip content="查看" placement="top">
                                    <router-link target="_blank" :to="`/stat/device/station/detail/${station.station_id}?title=${title}&operator_id=${operator_id}`" class="td-item see-icon"></router-link>
                                </el-tooltip>
                            </div>
                        </div>
