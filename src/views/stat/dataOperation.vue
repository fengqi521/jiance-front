<template>
  <section>
    <div class="section-title">运营数据分析</div>
    <div class="section-select">
      <span class="select-label">选择充电站</span>
      <el-select
        v-model="station_id"
        placeholder="请选择"
        style="width: 204px"
          ...
          <div class="statistic-item">
            ...
            <div class="statistic-content">
              ...
              <div class="statistic-detail">
                ...
                >
                  {{
                    parseFloat(header_info.s_user_count)
                      ? header_info.s_user_count
                      : 0
                  }}
                </span>
              </div>
          ...
          <div class="statistic-item" style="background: #7f84c0">
            ...
            <div class="statistic-content">
              ...
              <div class="statistic-detail">
                ...
                >
                  {{
                    parseFloat(header_info.s_order_total)
                      ? header_info.s_order_total
                      : 0
                  }}
                </span>
              </div>
          ...
          <div class="statistic-item" style="background: #ffb73c">
            ...
            <div class="statistic-content">
              ...
              <div class="statistic-detail">
                ...
                >
                  {{
                    parseFloat(header_info.s_station_count)
                      ? header_info.s_station_count
                      : 0
                  }}
                </span>
              </div>
          ...
          <div class="statistic-item">
            ...
            <div class="statistic-content">
              ...
              <div class="statistic-detail">
                ...
                >
                  {{
                    parseFloat(header_info.s_pile_total)
                      ? header_info.s_pile_total
                      : 0
                  }}
                </span>
              </div>
          ...
          <div class="statistic-item" style="background: #7f84c0">
            ...
            <div class="statistic-content">
              ...
              <div class="statistic-detail">
                ...
                >
                  {{
                    parseFloat(header_info.s_quantity_total)
                      ? header_info.s_quantity_total
                      : 0
                  }}
                </span>
              </div>
              ...
              <div class="statistic-content">
                ...
                <div class="statistic-detail">
                  <span
                    class="ellipsis"
                    :style="{
                      color: parseFloat(header_info.s_service_total)
                        ? '#FFB73C'
                        : '',
                    }"
                  >
              ...
              <div class="statistic-content">
                ...
                <div class="statistic-detail">
                  <span
                    class="ellipsis"
                    :style="{
                      color: parseFloat(header_info.s_preferential_total)
                        ? '#80ADFF'
                        : '',
                    }"
                  >
              ...
              <div class="statistic-content">
                ...
                <div class="statistic-detail">
                  <span
                    class="ellipsis"
                    :style="{
                      color: parseFloat(header_info.s_unpaid_total)
                        ? '#80ADFF'
                        : '',
                    }"
                  >
              ...
              <div class="statistic-content">
                ...
                <div class="statistic-detail">
                  <span
                    class="ellipsis"
                    :style="{
                      color: parseFloat(header_info.s_charge_total)
                        ? '#7F84C0'
                        : '',
                    }"
                  >
              ...
              <div class="statistic-content">
                ...
                <div class="statistic-detail">
                  <span
                    class="ellipsis"
                    :style="{
                      color: parseFloat(header_info.s_real_total)
                        ? '#FF6632'
                        : '',
                    }"
                  >
              ...
              <div class="statistic-content">
                ...
                <div class="statistic-detail">
                  <span
                    class="ellipsis"
                    :style="{
                      color: parseFloat(header_info.s_handle_total)
                        ? '#7F84C0'
                        : '',
                    }"
                  >
    ...
    <div class="section-list section-analysis clearfix">
      ...
      <div class="section-item">
        ...
        <div class="section-item-content">
          ...
          <div
            is="orderProfitChart"
            ref="orderProfitChart"
            label="seven_order_data"
          ></div>
        </div>
      </div>
      <div class="section-item">
        ...
        <div class="section-item-content">
          ...
          <div
            is="electricProfitChart"
            ref="electricProfitChart"
            label="seven_electic_data"
          ></div>
        </div>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    getSevenUserCount: function () {
      ...
      this.$api
        ...
        .then((res) => {
          ...
          //近7天营收分析（电量）
          electricProfitChart &&
            electricProfitChart.showElectricProfitChart(res.data);
        });
    },
    ...
    getSevenChargingPercent: function () {
      const that = this;
      this.$api
        .getOperationSevenChargingPercent({
          provinceCode: this.area_id,
          station_id: this.station_id,
          operator_id: this.operator_id,
        })
    ...
    getStations() {
      this.station_id = "";
      this.$api
        .getMaintenanceStationData({ operator_id: this.operator_id })
        .then((res) => {
          if (res.code === 1) {
            const data = res.data || {};
