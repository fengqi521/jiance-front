<template>
  <section>
    <div class="section-title">
      <router-link
        :to="`/stat/device/station?title=${title}&operator_id=${operator_id}`"
        >充电站管理</router-link
      >
      > 充电站详情
    </div>
    ...
    <div class="section-container">
      <div class="section-item-router">
        <router-link
          :to="`/stat/device/station/detail/${stationInfo.station_id}?title=${title}&operator_id=${operator_id}`"
          class="section-act"
          >基本信息</router-link
        >
        <router-link
          :to="`/stat/device/station/operate/${stationInfo.station_id}?title=${title}&operator_id=${operator_id}`"
          >运营信息</router-link
        >
        <router-link
          :to="`/stat/device/station/park/${stationInfo.station_id}?title=${title}&operator_id=${operator_id}`"
          >有序充电配置</router-link
        >
      </div>
              ...
              <div class="info-item">
                ...
                <div class="info-item-right">
                  <el-form-item class="radio-outer" prop="is_app">
                    <el-radio v-model="stationInfo.is_app" label="1"
                      >是</el-radio
                    >
                    <el-radio v-model="stationInfo.is_app" label="0"
                      >否</el-radio
                    >
                  </el-form-item>
                </div>
              ...
              <div class="info-item">
                ...
                <div class="info-item-right">
                  <el-form-item class="radio-outer" prop="is_community">
                    <el-radio v-model="stationInfo.is_community" label="1"
                      >是</el-radio
                    >
                    <el-radio v-model="stationInfo.is_community" label="0"
                      >否</el-radio
                    >
                  </el-form-item>
                </div>
              ...
              <!-- <div class="info-item">
                                ...
                                <div class="info-item-right province-item">
                                    <el-form-item prop="province_code">
                                        <el-select v-model="stationInfo.province_code" placeholder="所属行政省" @change="changeProvinceSelect">
                                            <el-option class="province-option" v-for="(item, index) in provinceList" :key="index" :label="item.name" :value="item.code" />
                                        </el-select>
                                    </el-form-item>
                                    <el-form-item prop="city_code">
                                        <el-select v-model="stationInfo.city_code" placeholder="所属行政市" @change="changeCitySelect">
                                            <el-option class="province-option" v-for="(item, index) in cityList" :key="index" :label="item.name" :value="item.code" />
                                        </el-select>
                                    </el-form-item>
                                    <el-form-item prop="area_code">
                                        <el-select v-model="stationInfo.area_code" placeholder="所属行政区">
                                            <el-option class="province-option" v-for="(item, index) in areaList" :key="index" :label="item.name" :value="item.code" />
                                        </el-select>
                                    </el-form-item>
                                </div>
                            </div> -->
                  ...
                  <el-form-item prop="province_code" v-if="fourSelect == '1'">
                    ...
                    >
                      <div class="four-select">
                        <div
                          :class="{ 'select-checked': fourSelect == 1 }"
                          @click="changeFourSelect('1')"
                        >
                          省
                        </div>
                        <div
                          :class="{ 'select-checked': fourSelect == 2 }"
                          @click="changeFourSelect('2')"
                        >
                          市
                        </div>
                        <div
                          :class="{ 'select-checked': fourSelect == 3 }"
                          @click="changeFourSelect('3')"
                        >
                          区
                        </div>
                        <div
                          :class="{ 'select-checked': fourSelect == 4 }"
                          @click="changeFourSelect('4')"
                        >
                          街道
                        </div>
                      </div>
              ...
              <div class="info-item">
                ...
                <div class="info-item-right">
                  <el-form-item prop="position">
                    ...
                    />
                    <button class="station-position-button">
                      <a
...
export default {
  data() {
    ...
    const operator_id =
      (this.$route.query && this.$route.query.operator_id) || "";
    return {
      connectLabel: '',
      provinceLabel: '',
      cityLabel: '',
