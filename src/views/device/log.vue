      ...
      <div class="header-content clearfix">
        <div class="content-item">
          ...
          <el-input
            ...
            :placeholder="`请输入${placeholder_arr[modelObj.sea_type]}`"
          />
        </div>
        <div class="content-item">
        ...
        <div class="content-item">
          ...
          <div class="header-right">
            <el-select v-model="modelObj.etype">
              <el-option
                label="全部"
                value=""
              />
      ...
      <div class="section-main">
        <div class="table">
          <div class="table-th clearfix">
            ...
            <div class="table-td">事件</div>
            <div class="table-td">故障类型</div>
            <div class="table-td">故障描述</div>
          ...
          >
            <div
              ...
              v-for="(fault, index) in tableData"
              :key="index"
            >
              ...
              <div class="table-td">
                <div class="td-item td-time">{{fault.dt?fault.dt:'--'}}</div>
              </div>
              <div class="table-td">
                <div class="td-item">{{etype_array[fault.etype]}}</div>
              </div>
              <div class="table-td">
                <div class="td-item">{{fault.ftype?ftype_array[fault.ftype]:'--'}}</div>
              </div>
              <div class="table-td">
                <div class="td-item" v-if="fault.ftype ==8">{{fault.code?fault.code:'--'}}</div>
                <div class="td-item" v-else>{{fault.desc?fault.desc:'--'}}</div>
              </div>
              <div class="table-td">
                <div class="td-item">{{fault.opuser}}</div>
              </div>
              <div class="table-td">
                <div class="td-item td-time">{{fault.etype == 2 && fault.dt?fault.dt:'--'}}</div>
              </div>
            </div>
            <div
  ...
  methods: {
    ...
    /*
      ...
      /*
         ...
         */
      faultExport() {
          window.location.href = `${this.ENV}/malfunction/export?start_time=${this.modelObj.start_time}&end_time=${this.modelObj.end_time}&station_id=${this.modelObj.station_id}&sea_type=${this.modelObj.sea_type}&search=${this.modelObj.search}&ftype=${this.modelObj.ftype}&etype=${this.modelObj.etype}`;
      }
  }
};
</script>
<style lang="scss" scoped>
@import "../../assets/css/device/log.scss";
</style>
