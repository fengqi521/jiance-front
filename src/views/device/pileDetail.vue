<template>
  <section>
    <div class="section-title">
      <router-link to="/device/pile">充电桩管理</router-link> > 充电桩详情
    </div>
    <p class="section-name">充电桩名称：{{ pile_detail_name }}</p>
    <div class="section-container">
      <div class="section-item-router">
        <router-link :to="`/device/pile/detail/${modelInfo.id}`" class="section-act">基本信息
        </router-link>
        <router-link :to="`/device/pile/operate/${modelInfo.id}`">运营信息</router-link>
      </div>
        ...
        <div class="section-info" v-loading="loadingInfo">
          <div class="info-content clearfix">
            <div class="info-left">
              ...
              <!-- 所属厂家 -->
              <div class="info-item">
                <div class="info-item-left"><i>*</i>所属厂家</div>
                <div class="info-item-right">
              ...
              <!-- 充电桩类型 -->
              <div class="info-item">
                <div class="info-item-left"><i>*</i>充电桩类型</div>
                <div class="info-item-right">
              ...
              <!-- 额定电压 -->
              <div class="info-item">
                <div class="info-item-left"><i>*</i>额定电压</div>
              ...
              <!-- 充电口数量  -->
              <div class="info-item">
                <div class="info-item-left"><i>*</i>充电口数量</div>
                <div class="info-item-right">
              ...
              <!-- 充电枪类型 -->
              <div class="info-item">
                <div class="info-item-left"><i>*</i>充电枪类型</div>
                <div class="info-item-right">
            ...
            <div class="info-right">
              <!-- 运行编码 -->
              <div class="info-item">
                <div class="info-item-left"><i>*</i>充电桩编号</div>
                <div class="info-item-right">
              ...
              <!-- 额定功率 -->
              <div class="info-item">
                <div class="info-item-left"><i>*</i>额定功率</div>
                <div class="info-item-right voltage-outer">
                  <div class="voltage-item">
              ...
              <!-- 额定电流 -->
              <div class="info-item">
                <div class="info-item-left"><i>*</i>额定电流</div>
                <div class="info-item-right">
              ...
              <div class="info-item">
                ...
                <div class="info-item-right input-150">
                  <el-form-item prop="oper_date">
                    <el-date-picker v-model="modelInfo.oper_date" type="date" placeholder="选择日期"
          ...
          <!-- 提交 -->
          <div class="btn_succ section-bottom" @click="saveDeviceInfo">
            提交
          </div>
        </div>
      </el-form>
  ...
  data() {
    return {
      ...
      dataRules: {
        ...
        manufacture_name: [
          { required: true, message: '* 请输入所属厂家', trigger: 'change' },
        ],
        pile_type: [
