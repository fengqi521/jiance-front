  ...
  <section>
    ...
    <div class="section-container">
      <div class="section-item-router">
        <router-link :to="`/device/pile/detail/${id}`">基本信息</router-link>
        <router-link :to="`/device/pile/operate/${id}`" class="section-act"
        >运营信息</router-link
        >
      </div>
              ...
              <div class="info-item">
                ...
                <div class="info-item-right">
                  <el-form-item prop="station_name">
                    <el-input
                            disabled
                            v-model="modelInfo.station_name"
                            placeholder="填写关联充电站"
                    />
                    <span
                            v-if="modelInfo.source !== '2'"
                            class="btn_succ operate-btn"
                ...
                <div class="info-item-right">
                  <div class="user-form">
                    <div class="radio-outer">
                      <el-radio v-model="modelInfo.user_flag" label="1"
                      >所有用户</el-radio
                      >
                      <el-radio v-model="modelInfo.user_flag" label="2"
                      >名单用户</el-radio
                      >
                    </div>
                    <div v-if="modelInfo.user_flag == 2" class="open-listUser">
                      <div class="listUser-main">
                        <el-form-item prop="_user">
                          <el-input
                                  type="hidden"
                                  v-model="modelInfo._user"
                          ></el-input>
                          <div class="listUser-content scrollBar clearfix">
                            <div
                                    class="listUser-item"
                                    v-for="(item, _index) in modelInfo.users"
                                    :key="_index"
                            >
    ...
    <!-- 选择充电站 -->
    <div
            v-if="modelInfo.source"
            is="addStationModel"
            :station_id.sync="modelInfo.station_id"
            :station_name.sync="modelInfo.station_name"
            :showModel.sync="showAddStation"
