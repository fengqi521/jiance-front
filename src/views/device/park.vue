  ...
  <section>
    ...
    <div class="section-container">
      <div class="section-item-router">
        ...
        <router-link
          :to="`/device/station/operate/${stationInfo.station_id}`"
        >运营信息</router-link>
        <router-link :to="`/device/station/park/${stationInfo.station_id}`" class="section-act">有序充电配置</router-link>
      </div>
      <el-form
        :model="stationInfo"
        ref="stationInfo"
              ...
              <div class="info-left">
                ...
                <div class="info-item">
                  ...
                  <div class="info-item-right">
                    ...
                    >
                      <el-radio
                              v-model="stationInfo.is_limit_charge"
                              label="1"
                      >是</el-radio>
                      <el-radio
                              v-model="stationInfo.is_limit_charge"
                ...
                <div class="info-item">
                  ...
                  <div class="info-item-right">
                    <el-form-item>
                      <el-input
                              :disabled="stationInfo.is_limit_charge!=1"
                              v-model="stationInfo.total_power"
                              placeholder="填写正整数"
                  ...
                  <div class="info-item-right">
                    <el-form-item>
                      <el-input
                              :disabled="stationInfo.is_limit_charge!=1"
                              type="textarea"
                              v-model="stationInfo.limit_charge_note"
                              maxlength="200"
                ...
                <!-- 备注 -->
                <div class="info-item">
                  <div class="info-item-left"><i v-if="stationInfo.is_limit_charge == '1'">*</i>时段</div>
                  <div class="info-item-right">
                    <!-- 时段设置 -->
                    <div
                            v-if="stationInfo._peak_time.length > 0"
                            class="chargeRate-content"
                    >
                      <div class="chargeRate-content-right">
                        <div
                                class="chargeRate-list"
                                v-for="(item,index) in stationInfo._peak_time"
                                :key="index"
                        >
                          ...
                          <el-input
                                  v-model="item['limit_power']"
                                  type="number"
                                  min="1"
                                  placeholder="填写正整数"
                                  class="threshold-power"
                                  :disabled="stationInfo.is_limit_charge!=1"
                          />
                          <span class="time-power-unit">KW</span>
                          <div class="interval-btn" v-if="stationInfo.is_limit_charge ==1">
                            <div
                                    v-if="index == stationInfo._peak_time.length-1"
                                    class="btn_succ add-interval"
                                    @click="addTimeInterval('_peak_time')"
                            >添加时段</div>
                            <div
                                    v-if="index != stationInfo._peak_time.length-1"
                                    class="btn_cancel del-interval"
                                    @click="delTimeInterval('_peak_time',index)"
                            >删除</div>
                          </div>
