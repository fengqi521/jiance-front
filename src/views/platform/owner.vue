<template>
  <section>
    <div class="section-title">业主</div>
    <div class="section-tips">
        <i class="warning-icon"></i>
        <span class="tips-text">注意：业主是桩的拥有者，可能是一个公司或某个个体，可以查看桩的账单。</span>
    </div>
    <div class="section-header">
      ...
      <div class="header-content clearfix">
        <div class="content-item">
          <div class="header-left">业主账号</div>
    ...
    <div class="section-container">
      <div class="section-item-header clearfix">
        ...
        <div class="btn_succ add-coupon" @click="handleAdd">
          <i class="add-station"></i>添加业主
        </div>
      </div>
      <div class="section-main">
        <div class="table">
          <div class="table-th clearfix">
            <div class="table-td">业主账号</div>
            <div class="table-td">业主类型</div>
          ...
          <div class="table-body" v-loading="listLoading">
            ...
            >
              ...
              <div class="table-td table-operate" style="min-width:156px;">
                ...
                >
                  <router-link
                    :to="`/platform/owner/detail/${owner.id}`"
                ...
                >
                  <router-link
                    :to="`/platform/owner/edit/${owner.id}`"
                ...
                <el-tooltip
                  ...
                  placement="top"
                >
                  <div class="td-item delete-icon" @click="delItem(owner.id)"></div>
                </el-tooltip>
                <el-tooltip
                content="关联"
                placement="top"
                >
                  ...
                  :to="`/platform/owner/assign/${owner.id}/${owner.account}`"
                  ></router-link>
                </el-tooltip>
              </div>
            </div>
...
export default {
  ...
  methods: {
    ...
    // 确认删除
    saveDeleteSure() {
      this.$api.roleDelOwner({id: this.delete_id}).then(data => {
        this.delete_id = "";
    ...
    getTableDataList() {
      ...
      this.$api.roleOwners(this.modelObj).then(data => {
    ...
    handleAdd(){
      this.$router.push(`/platform/owner/add`)
    }
  }
};
</script>
