<template>
  <section>
    <div class="section-title">
      <router-link to="/platform/owner" >业主</router-link> > 业主详情
    </div>
          ...
          >
            ...
            >
              ...
              <div class="table-td table-status">
                <div :class="['td-item',{'td-online section-running':pile_info.online_status == 1}]">
...
export default {
  ...
  methods: {
    getTableDataList() {
      ...
      this.$api.roleOwnerDetail(param).then(data => {
