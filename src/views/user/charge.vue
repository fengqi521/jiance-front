    ...
    <section>
        ...
        <div class="section-header">
            <div class="section-item-router">
                ...
                <router-link :to="`/user/users/charge/${user_id}`" class="section-act">充电记录</router-link>
            </div>
                ...
                <div class="table">
                    ...
                    >
                        ...
                        >
                            ...
                            <div class="table-td">
                                <div class="td-item">{{item.pile_sn+'-'+item.gun_sn}}</div>
                            </div>
                            <div class="table-td">
                            ...
                            <div class="table-td table-operate">
                                ...
                                <div
                                        class="td-item btn_delete" style="cursor: pointer;"
                                        v-if="item.charge_status == 0||item.charge_status == 1 || item.charge_status == 3"
                                        @click="stopChargeHandler(item.out_trade_id,item.charge_status)"
                                >取消
                                </div>
                                <div
                                        class="td-item " style="cursor: pointer;"
                                        v-else-if="item.charge_status == 2"
                                        @click="stopChargeHandler(item.out_trade_id,item.charge_status)"
                                >停止
                                </div>
                                <div
    ...
    export default {
        ...
        methods: {
            ...
            getTableDataList() {
                ...
                this.$api.userChargeList(this.modelObj).then(data => {
            ...
            saveStopSure() {
                ...
                this.$api.setStopCharge(this.stopChargeParam).then(data => {
                    this.listLoading = false;
...
<style lang="scss" scoped>
    @import "../../assets/css/user/charge.scss";
</style>
