        ...
        <div v-loading="listLoading">
            <div class="section-list">
                <div class="section-item-header clearfix">
                    <span>APP用户隐私政策页面</span>
                </div>
                <div class="header-main clearfix">
                    <div class="left">
                        <div class="left-top"><img  src="./image/privacy_top.png"></div>
                    ...
                    <div class="right">
                        <div class="right-top ">
                            ...
                            <p class="right-top-content">此页面为APP用户隐私政策页面，配置后将显示在APP上，系统自动填入默认模板，修改后及时更新。</p>
                        </div>
...
<script>
    export default {
        ...
        methods: {
            ...
            //保存修改的配置消息
            saveChange(){
                this.$api.saveAgreement({title:this.title,content:this.content,type:1}).then(res=>{
                    if(res.code ==1 ){
                        this.$sfNotify({
                            message: "成功",
                        });
