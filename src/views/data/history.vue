          ...
          <div class="table-body" v-loading="listLoading">
            ...
            >
              ...
              <div class="table-td">
                <div
                  class="td-item"
                  :class="{ 'section-no-begin': pile.plug_status != '1' }"
                >
              ...
              <div class="table-td table-operate">
                <el-tooltip content="查看" placement="top" v-if="detail_rule">
                  <router-link
                    target="_blank"
                    :to="`/data/history/detail/${pile.pile_name}/${pile.pile_sn}/${pile.pile_type}`"
...
export default {
  ...
  methods: {
    ...
    getTableDataList() {
      ...
      this.$api.getHistoryPileList(this.modelObj).then((data) => {
        this.listLoading = false;
        if (data.code == 1) {
          this.tableData = data.data.list;
          this.currentPage = data.data.current_page;
          this.page_count = data.data.page_total;
          this.detail_rule = data.data.detail_rule;
        }
      });
    },
    searchPile() {
